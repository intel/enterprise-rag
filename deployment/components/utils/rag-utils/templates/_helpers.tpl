...
The watcher pod must be outside the ambient mesh to reliably reach the API server
even when the mesh it is repairing is broken. 'default' is not labeled for ambient.
*/}}
