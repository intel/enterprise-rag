...
def reset_singleton():
    ...
    EragTextCompressor._instance = None
    yield

def test_singleton_pattern(reset_singleton):
    """Test that EragTextCompressor follows the singleton pattern."""
    compressor1 = EragTextCompressor()
    compressor2 = EragTextCompressor()
