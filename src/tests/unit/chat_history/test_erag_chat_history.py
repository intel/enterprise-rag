...
from comps.chat_history.utils.erag_chat_history import EragChatHistoryConnector
from comps.chat_history.utils.documents import ChatHistoryDocument

@pytest.fixture
def test_class():
    return EragChatHistoryConnector(mongodb_host="localhost", mongodb_port=27017)
...
def test_erag_chat_history_connector_initialization_succeeds():
    connector = EragChatHistoryConnector(mongodb_host="localhost", mongodb_port=27017)
    assert isinstance(connector, EragChatHistoryConnector), "Instance was not created successfully."


@pytest.mark.asyncio
@patch('comps.chat_history.utils.erag_chat_history.ChatHistoryDocument')
@patch('comps.chat_history.utils.erag_chat_history.EragChatHistoryConnector.insert')
...
@pytest.mark.asyncio
@patch('comps.chat_history.utils.erag_chat_history.EragChatHistoryConnector.get_by_id')
...
@pytest.mark.asyncio
@patch('comps.chat_history.utils.erag_chat_history.EragChatHistoryConnector.get_by_id')
@patch('comps.chat_history.utils.erag_chat_history.EragChatHistoryConnector.delete')
...
def test_format_created_at_truncates_microseconds_to_milliseconds():
    ...
    from comps.chat_history.utils.erag_chat_history import _format_created_at
