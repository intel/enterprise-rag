...
@pytest.fixture
def test_class():
    """Fixture to create EragTranslator instance."""
    return EragLanguageDetector()

@pytest.fixture
def test_class_standalone():
    """Fixture to create EragTranslator instance for standalone functionality"""
    return EragLanguageDetector(is_standalone=True)
...
def test_initialization_succeeds():
    ...
    assert isinstance(EragLanguageDetector(), EragLanguageDetector), "Instance was not created successfully."
    assert isinstance(EragLanguageDetector(is_standalone=True), EragLanguageDetector), "Instance was not created successfully."
