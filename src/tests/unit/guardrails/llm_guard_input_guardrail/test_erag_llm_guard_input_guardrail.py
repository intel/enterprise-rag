...
from comps.cores.proto.docarray import BanSubstringsModel, LLMGuardInputGuardrailParams, LLMParamsDoc, LLMPromptTemplate
from comps.guardrails.llm_guard_input_guardrail.utils.llm_guard_input_guardrail import EragLLMGuardInputGuardrail
...
def test_scan_llm_input_valid(mock_scan_prompt, mock_input_scanners_config, mock_input_doc):
    ...
    guardrail = EragLLMGuardInputGuardrail({})
