...
from comps.cores.proto.docarray import BanSubstringsModel, GeneratedDoc, LLMGuardOutputGuardrailParams
from comps.guardrails.llm_guard_output_guardrail.utils.llm_guard_output_guardrail import EragLLMGuardOutputGuardrail
...
def test_scan_llm_output_valid(mock_scan_output, mock_output_scanners_config, mock_output_doc):
    ...
    guardrail = EragLLMGuardOutputGuardrail({})
