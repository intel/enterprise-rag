...
class SharepointHelper():
    ...
    def __init__(self):
        ...
        self.tenant_id = cfg.get("erag_keycloak_oidc_tenant_id")
        self.client_id = cfg.get("erag_keycloak_oidc_client_id")
        self.client_secret = cfg.get("erag_keycloak_oidc_client_secret")
