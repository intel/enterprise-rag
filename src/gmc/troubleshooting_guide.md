...
1. Root node existence
   ...
   ```
   The GMCConnector "chatqna" is invalid: spec.nodes: Invalid value: map[string]v1alpha3.Router{"node1":...}: a root node is required
   ```
