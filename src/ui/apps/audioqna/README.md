...
If you would like to setup custom domain, please change value for `base_domain_name` in `env/<name>/global_config.yaml`.

To change disclaimer displayed under text input on the Chat page, please change chatDisclaimerText value in [UI configuration variables for deployment](../../../../deployment/roles/app_ui/defaults/main.yaml).
