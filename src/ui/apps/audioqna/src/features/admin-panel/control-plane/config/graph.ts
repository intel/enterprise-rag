...
const graphNodes = [
  ...
  createNode(GraphNodeId.Asr, {
    displayName: "ASR",
    position: { x: 440, y: 432 },
    sourcePosition: Position.Right,
  }),
  createNode(GraphNodeId.VllmAudioCpu, {
    displayName: "vLLM Audio",
    position: { x: 640, y: 432 },
    targetPosition: Position.Left,
  }),
  createNode(GraphNodeId.Tts, {
    displayName: "TTS",
    position: { x: 440, y: 576 },
    sourcePosition: Position.Right,
  }),
  createNode(GraphNodeId.TtsModelServer, {
...
const graphEdges = [
  ...
  createEdge(GraphNodeId.Asr, GraphNodeId.VllmAudioCpu),
  createEdge(GraphNodeId.Tts, GraphNodeId.TtsModelServer),
];
