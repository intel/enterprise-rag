...
export interface DataIngestionSettingsState {
  processingTimeFormat: ProcessingTimeFormat;
...
export const selectProcessingTimeFormat = (state: {
  dataIngestionSettings: DataIngestionSettingsState;
}) => state.dataIngestionSettings.processingTimeFormat;

export const selectIsAutorefreshEnabled = (state: {
  dataIngestionSettings: DataIngestionSettingsState;
}) => state.dataIngestionSettings.isAutorefreshEnabled;

export const dataIngestionSettingsReducer = dataIngestionSettingsSlice.reducer;
