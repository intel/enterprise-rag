...
import { SUPPORTED_FILE_EXTENSIONS_BASE } from "@/utils/constants";
import { validateFileInput } from "@/validators/filesInput";
...
const FilesInput = ({ files, setFiles }: FilesInputProps) => {
  ...
  return (
    <FileInput
      ...
      supportedFileExtensions={SUPPORTED_FILE_EXTENSIONS_BASE}
