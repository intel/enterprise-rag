...
from comps.cores.proto.docarray import TextCompressionInput, TextSplitterInput
from comps.cores.utils.utils import sanitize_env
from comps.text_compression.utils.erag_text_compression import EragTextCompressor


# Define the unique service name for the microservice
USVC_NAME='erag_service@text_compression'
...
# Initialize an instance of the EragTextCompressor class with environment variables.
erag_text_compressor = EragTextCompressor(default_techniques=sanitize_env(os.getenv("DEFAULT_TEXT_COMPRESSION_METHODS")))
...
async def invoke(input: TextCompressionInput) -> TextSplitterInput:
    ...
    try:
        ...
        compressed_docs = await erag_text_compressor.compress_docs(
