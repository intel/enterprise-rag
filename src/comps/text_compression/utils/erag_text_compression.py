...
class EragTextCompressor:
    ...
    def __new__(cls, default_techniques: str = None):
        ...
        if cls._instance is None:
            cls._instance = super(EragTextCompressor, cls).__new__(cls)
            cls._instance._initialize(default_techniques)
        else:
            if (cls._instance.default_techniques_str != default_techniques):
                logger.warning(f"Existing EragTextCompressor instance has different parameters: "
