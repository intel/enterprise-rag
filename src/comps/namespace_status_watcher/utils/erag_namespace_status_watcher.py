...
class EragNamespaceStatusWatcher:
    """ERAG Namespace Status Watcher utility class for querying Kubernetes resources."""
    ...
    def __init__(self, target_namespace: str):
        ...
        logger.info(f"EragNamespaceStatusWatcher initialized for namespace: {self._target_namespace}")
