...
from comps.cores.proto.docarray import EmbedDoc, EmbedDocList, LateChunkingInput, TextDoc, TextDocList
...
class EragLateChunking:
    def __init__(self, 
        ...
        """
        Initialize the ERAG Late Chunking service.
