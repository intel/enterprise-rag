# Intel® AI for Enterprise RAG ASR Microservice

Part of the Intel® AI for Enterprise RAG ecosystem.

## 🔍 Overview

The Intel® AI for Enterprise RAG ASR (Automatic Speech Recognition) microservice converts audio files to text using Whisper or compatible ASR models. It interfaces with ASR model servers to process audio and return transcriptions.
...
- Intel® AI for Enterprise RAG Text Splitter can divide the transcribed text into chunks for data ingestion
- Intel® AI for Enterprise RAG Retriever & Reranker microservices can use transcriptions for document retrieval
