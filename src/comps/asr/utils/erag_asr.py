...
class EragAsr:
    def __init__(
        ...
        """
        Initialize the ERAG ASR instance with the given parameters.
        ...
        logger.info(
            f"ERAG ASR Microservice is configured to send requests to service {self._model_server_endpoint}"
        )
    ...
    def _validate_model_server(self, timeout_sec: int = 30) -> None:
        ...
        logger.info("EragAsr model server connection validated successfully.")
