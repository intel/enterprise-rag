...
# Args allowed in openai-like chat completions API calls in EragTextGenService
...
# Args allowed in openai-like regular completion API calls in EragTextGenService
