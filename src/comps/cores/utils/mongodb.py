...
logger = get_erag_logger("EragMongoConnector")


class EragMongoConnector(ABC):
    def __init__(self, host: str, port: int, documents: Union[Document, List[Document]], db_name: str = "ERAG"):
        self.host = host
        self.port = port
