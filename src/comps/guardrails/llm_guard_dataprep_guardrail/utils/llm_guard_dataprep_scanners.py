...
class DataprepScannersConfig(ScannersConfigBase):

    _SCANNER_KIND = "dataprep"

    def __init__(self, config_dict):
        self._logger = logger
        self._dataprep_scanners_config = self._build_scanners_config_from_env(ENABLED_SCANNERS, config_dict)
    ...
    def create_enabled_dataprep_scanners(self):
        ...
        """
        return self._create_enabled_scanners(self._dataprep_scanners_config, self._create_dataprep_scanner)
    ...
    def changed(self, new_scanners_config):
        ...
        """
        return self._config_changed(self._dataprep_scanners_config, new_scanners_config)
