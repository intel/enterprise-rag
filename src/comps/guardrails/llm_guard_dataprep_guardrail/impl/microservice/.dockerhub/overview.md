...
- The Intel AI for Enterprise RAG Dataprep service processes only data that has passed the dataprep guardrail scans, ensuring safety and policy compliance before vector search ingestion.
