...
from utils import erag_ingestion


# Define the unique service name for the microservice
USVC_NAME='erag_service@ingestion'
...
# Initialize an instance of the EragIngestion class with environment variables.
ingestion = erag_ingestion.EragIngestion(
