...
from utils import erag_textsplitter


# Define the unique service name for the microservice
USVC_NAME='erag_service@text_splitter'
...
# Initialize an instance of the EragTextSplitter class with environment variables.
# EragTextSplitter is a singleton so we initialize it with the environment variables.
...
def run_splitter(loaded_docs, chunk_size, chunk_overlap, use_semantic_chunking):
    erag_splitter = erag_textsplitter.EragTextSplitter(
    ...
    textdocs = erag_splitter.split_docs(
