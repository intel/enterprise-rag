...
class EragVectorStore():
    """
    A class representing a vector store for ERAG.
    Args:
    ...
    def __new__(cls, vector_store: Optional[str] = None):
        """
        Creates a new instance of the EragVectorStore class.
        Args:
            vector_store (str, optional): The type of vector store to use. Defaults to None.
        Returns:
            EragVectorStore: The EragVectorStore instance.
        """
        if cls._instance is None:
            cls._instance = super(EragVectorStore, cls).__new__(cls)
            cls._instance._initialize(vector_store)
        return cls._instance

    def _initialize(self, vector_store_name: str):
        """
        Initializes the EragVectorStore instance.
        Args:
