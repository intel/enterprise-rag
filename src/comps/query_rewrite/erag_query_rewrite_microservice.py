...
from comps.query_rewrite.utils.erag_query_rewrite import EragQueryRewrite


USVC_NAME = "erag_service@query_rewrite"
...
erag_query_rewrite = EragQueryRewrite(
...
@register_microservice(
    ...
    validate_methods=[erag_query_rewrite._validate],
)
...
async def process(input: TextDoc, request: Request) -> TextDoc:
    ...
    try:
        ...
        result = await erag_query_rewrite.run(
            input,
            access_token,
