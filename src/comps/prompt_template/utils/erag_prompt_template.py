...
from comps.cores.proto.docarray import LLMParamsDoc, LLMPromptTemplate, PromptTemplateInput, TextDoc
...
class EragPromptTemplate:
    def __init__(self, chat_history_endpoint: str = None, prompt_template_language: str = "en") -> None:
        ...
        logger.info("Initializing EragPromptTemplate with default template")
